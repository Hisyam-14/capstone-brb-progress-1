...
<body>
    ...
    <main>
        <div id="Autoplaying" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="assets/img/slide1.jpg" class="d-block w-100 carousel-img" alt="Slide 1">
                </div>
                <div class="carousel-item">
                    <img src="assets/img/slide2.jpg" class="d-block w-100 carousel-img" alt="Slide 2">
                </div>
                <div class="carousel-item">
                    <img src="assets/img/slide3.jpg" class="d-block w-100 carousel-img" alt="Slide 3">
                </div>
            </div>
                ...
                <div class="row align-items-center" style="min-height: 400px;">
                    ...
                    <div class="col-md-6 d-flex justify-content-center align-items-center">
                        <div>
                            ...
                            <p>Fungsi utama Dinas Kehutanan meliputi kebijakan teknis, perlindungan dan konservasi sumber daya alam, pengelolaan daerah aliran sungai (DAS), rehabilitasi hutan, serta penyuluhan dan pemberdayaan masyarakat.</p>
                            <p>Dinas ini membawahi beberapa Unit Pelaksana Teknis Daerah (UPTD) seperti KPHP Berau Barat, KPHP Bengalon, KPHP Santan, dan KPHL Balikpapan, serta Taman Hutan Raya Bukit Soeharto.</p>
                            <p>Komitmen utama Dinas Kehutanan adalah menjaga kelestarian hutan Kalimantan Timur untuk generasi mendatang.</p>
                        </div>
                    </div>
                </div>
            </div>
